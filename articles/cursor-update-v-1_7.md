...
また公式では「ブラウザでの利用には、最高のパフォーマンスのためにSonnet4.5を推奨しています。AutoとGPT-5も有力な選択肢です。」と記載があります。
GPT-5やSonnet4.5と並ぶとはAutoの精度がかなり上がっているのですかね…
:::
...
## 実際の挙動
下準備
![](/images/cursor-update-v-1_7/7.png)
画像のようにBrowserが有効になっていること
![](/images/cursor-update-v-1_7/8.png)
...
```
![](/images/cursor-update-v-1_7/9.png)
起動中のURL、ログイン用のメールアドレス、パスワードを教えた後の実行結果。
![](/images/cursor-update-v-1_7/10.png)
![](/images/cursor-update-v-1_7/11.png)
cursorが撮影したスクショ
![](/images/cursor-update-v-1_7/12.png)
